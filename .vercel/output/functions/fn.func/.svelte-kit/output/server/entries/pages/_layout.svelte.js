import { c as create_ssr_component, b as compute_rest_props, d as spread, e as escape_attribute_value, f as escape_object, g as add_attribute, v as validate_component } from "../../chunks/ssr.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="h-screen bg-white dark:bg-gray-800 flex flex-col">${validate_component(DarkMode, "DarkMode").$$render($$result, {}, {}, {})} ${slots.default ? slots.default({}) : ``}</div>`;
});
export {
  Layout as default
};
