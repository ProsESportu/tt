import { c as create_ssr_component, b as compute_rest_props, a as setContext, g as add_attribute, d as spread, f as escape_object, e as escape_attribute_value, h as getContext, j as escape, v as validate_component, k as each } from "../../chunks/ssr.js";
import { a as twJoin, t as twMerge } from "../../chunks/tw-merge.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${$$result.head += `<!-- HEAD_svelte-1lc14l5_START -->${$$result.title = `<title>${escape(data.title)}</title>`, ""}<!-- HEAD_svelte-1lc14l5_END -->`, ""} ${validate_component(Table, "Table").$$render($$result, { hoverable: true }, {}, {
    default: () => {
      return `${validate_component(TableHead, "TableHead").$$render($$result, {}, {}, {
        default: () => {
          return `${each(data.head, (header) => {
      ...
      })} ${each(data.lessons, (row, index) => {
        return `${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
          default: () => {
            return `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
              default: () => {
                return `${escape(data.nrs[index])} `;
              }
            })} ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
              default: () => {
                return `${escape(data.hours[index])} `;
              }
            })} ${each(row, (cell) => {
              return `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
                default: () => {
                  return `${each(cell, (lesson) => {
                    return `${escape(lesson.name)}`;
                  })} `;
                }
              })}`;
            })} `;
